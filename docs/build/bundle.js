...
var app = (function () {
    ...
    var require$$1 = /*@__PURE__*/getAugmentedNamespace(acorn_es);
    ...
    const file$4 = "src/components/InputGroup.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$4, 4, 5, 70);
    			add_location(p, file$4, 4, 2, 67);
    ...
    const file$3 = "src/components/InputItem.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$2, 7, 0, 144);
    			attr_dev(input, "id", /*id*/ ctx[2]);
    			attr_dev(input, "type", "number");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "step", "1");
    			add_location(input, file$2, 8, 0, 176);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ nanoid, label, value, id });
    	...
    	return [value, label, id, input_input_handler];
    }

    class InputInteger extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { label: 1, value: 0 });
    		...
    		if (/*label*/ ctx[1] === undefined && !("label" in props)) {
    			console.warn("<InputInteger> was created without expected prop 'label'");
    		}
     ...
     */
    const ColorModes = ["tile", "distribution"];
    const Tiles = ["line", "wave", "peak"];
    const Directions = ["left", "right", "random"];

    /* src/components/InputColor.svelte generated by Svelte v3.35.0 */
    const file$1 = "src/components/InputColor.svelte";
    ...
    // (24:2) {#each ColorModes as cm}
    function create_each_block_3(ctx) {
    	let label;
    	let input;
    	let t0;
    	let t1_value = colorModes_text[/*cm*/ ctx[16]] + "";
    	let t1;
    	let t2;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			input.__value = /*cm*/ ctx[16];
    			input.value = input.__value;
    			/*$$binding_groups*/ ctx[4][0].push(input);
    			add_location(input, file$1, 25, 6, 753);
    			attr_dev(label, "class", "radio svelte-rlws9q");
    			add_location(label, file$1, 24, 4, 725);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    			append_dev(label, input);
    			input.checked = input.__value === /*colorConfig*/ ctx[0].mode;
    			append_dev(label, t0);
    			append_dev(label, t1);
    			append_dev(label, t2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:2) {#each ColorModes as cm}",
    		ctx
    	});
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*colorModes_text, ColorModes, colorConfig*/ 1) {
    				each_value_3 = ColorModes;
    				validate_each_argument(each_value_3);
    				let i;
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*colors, colorConfig*/ 3) {
    				each_value_2 = /*colors*/ ctx[1];
    				validate_each_argument(each_value_2);
    				let i;
    ...
    // (33:0) {#if colorConfig.mode == "tile"}
    function create_if_block(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value = Tiles;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*id, colorConfig, Tiles, colors, undefined, tiles_text*/ 7) {
    				each_value = Tiles;
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(33:0) {#if colorConfig.mode == \\\"tile\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	function inputinteger_value_binding(value) {
    		/*inputinteger_value_binding*/ ctx[6](value, /*color*/ ctx[13]);
    	}

    	let inputinteger_props = { label: /*color*/ ctx[13].name };

    	if (/*colorConfig*/ ctx[0].distribution[/*color*/ ctx[13].value] !== void 0) {
    		inputinteger_props.value = /*colorConfig*/ ctx[0].distribution[/*color*/ ctx[13].value];
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*colorConfig, colors*/ 3) {
    				updating_value = true;
    				inputinteger_changes.value = /*colorConfig*/ ctx[0].distribution[/*color*/ ctx[13].value];
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, colorConfig*/ 524289) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:2) {#each colors as color}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = /*c*/ ctx[10].value;
    			option.value = option.__value;

    			option.selected = option_selected_value = /*c*/ ctx[10].value == /*colorConfig*/ ctx[0].tile[/*t*/ ctx[7]]
    			? true
    			: undefined;

    			add_location(option, file$1, 38, 10, 1147);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*colorConfig, colors*/ 3 && option_selected_value !== (option_selected_value = /*c*/ ctx[10].value == /*colorConfig*/ ctx[0].tile[/*t*/ ctx[7]]
    			? true
    			: undefined)) {
    ...
    function create_default_slot$1(ctx) {
    	let label;
    	let t0_value = tiles_text[/*t*/ ctx[7]] + "";
    	let t0;
    	let t1;
    	let select;
    	let t2;
    	...
    	function select_change_handler() {
    		/*select_change_handler*/ ctx[5].call(select, /*t*/ ctx[7]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file$1, 35, 6, 1016);
    			attr_dev(select, "id", /*id*/ ctx[2]);
    			if (/*colorConfig*/ ctx[0].tile[/*t*/ ctx[7]] === void 0) add_render_callback(select_change_handler);
    			add_location(select, file$1, 36, 6, 1062);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    			append_dev(label, t0);
    			...
    			select_option(select, /*colorConfig*/ ctx[0].tile[/*t*/ ctx[7]]);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*colors, colorConfig, Tiles, undefined*/ 3) {
    			...
    			if (dirty & /*colorConfig, Tiles, colors*/ 3) {
    				select_option(select, /*colorConfig*/ ctx[0].tile[/*t*/ ctx[7]]);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*colorConfig*/ ctx[0].mode == "tile") return 0;
    		if (/*colorConfig*/ ctx[0].mode == "distribution") return 1;
    		return -1;
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["colorConfig"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<InputColor> was created with unknown prop '${key}'`);
    	});

    	const $$binding_groups = [[]];

    	function input_change_handler() {
    		colorConfig.mode = this.__value;
    		$$invalidate(0, colorConfig);
    		$$invalidate(1, colors);
    	}

    	function select_change_handler(t) {
    		colorConfig.tile[t] = select_value(this);
    		$$invalidate(0, colorConfig);
    		$$invalidate(1, colors);
    	}

    	function inputinteger_value_binding(value, color) {
    		if ($$self.$$.not_equal(colorConfig.distribution[color.value], value)) {
    			colorConfig.distribution[color.value] = value;
    			$$invalidate(0, colorConfig);
    		}
    	}

    	$$self.$$set = $$props => {
    		if ("colorConfig" in $$props) $$invalidate(0, colorConfig = $$props.colorConfig);
    	};
    ...
    class InputColor extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { colorConfig: 0 });
    		...
    		if (/*colorConfig*/ ctx[0] === undefined && !("colorConfig" in props)) {
    			console.warn("<InputColor> was created without expected prop 'colorConfig'");
    		}
    	}
    ...
    class UnitGrid {
        constructor(rows, columns, cell_ratio = 1, spacing = { column: 0, row: 0 }) {
            this.rows = rows;
    ...
    function interpolate_values(v1, v2, f) {
        return v1 + (v2 - v1) * f;
    }
    function interpolate_points(p1, p2, f) {
        //
        return new paperFull.Point(interpolate_values(p1.x, p2.x, f), interpolate_values(p1.y, p2.y, f));
    }

    function wave(p, w, h, s) {
        // Wave anchors
        const p0 = p;
        const p1 = p0.add(new paperFull.Point(w, h / 2));
        const p2 = p0.add(new paperFull.Point(0, h));
        // Calculating first anchors
        const p01 = p0.add(new paperFull.Point(0, (+h / 2) * s));
        const p10 = p1.add(new paperFull.Point(0, (-h / 2) * s));
        // Calculating second anchors
        const p12 = p1.add(new paperFull.Point(0, (+h / 2) * s));
        const p21 = p2.add(new paperFull.Point(0, (-h / 2) * s));
        // Drawing
    ...
    function tile_wave(r, d = 1, s = 0.5) {
        // Calculating origin point
        const p = new paperFull.Point(r.x + r.width / 2, r.y);
        // Getting path
        const path = wave(p, (d * r.width) / 4, r.height, s);
        return path;
    }

    function peak(p, w, h, d = 1, s = 0.56) {
        if (h < 2 * w) {
        ...
        const pM = p.add(new paperFull.Point(0, h / 2));
        // These are the first two points
        const p0 = p;
        const p1 = p0.add(new paperFull.Point(0, dst));
        // This is the peak point
        const p2 = p.add(new paperFull.Point(d * w, h / 2));
        // These are the last two points
        const p3 = pM.add(new paperFull.Point(0, w));
        const p4 = p.add(new paperFull.Point(0, h));
        // First two anchors
    ...
    function tile_peak(r, d = 1, s = 0.56) {
        // Calculating origin point
        const p = new paperFull.Point(r.x + r.width / 2, r.y);
        // Getting path
    ...
    function tile_line(r) {
        // Calculating origin point
        const p = new paperFull.Point(r.x + r.width / 2, r.y);
        // Getting path
        const path = new paperFull.Path.Line(p, p.add(new paperFull.Point(0, r.height)));
        return path;
    }
     ...
     */
    var random = createRandom$6(Math.random);

    /**
     * Exporting.
     */
    random.createRandom = createRandom$6;
    var random_1 = random;
    ...
    var createRandom$5 = random_1.createRandom;
     ...
     * @return {function}     - The created function.
     */
    function createRandomIndex$4(rng) {
      var customRandom = createRandom$5(rng);
     ...
     */
    var randomIndex = createRandomIndex$4(Math.random);

    /**
     * Exporting.
     */
    randomIndex.createRandomIndex = createRandomIndex$4;
    ...
    var createRandomIndex$3 = randomIndex_1.createRandomIndex;
    ...
    function createChoice(rng) {
      var customRandomIndex = createRandomIndex$3(rng);
     ...
     */
    var choice$1 = createChoice(Math.random);

    /**
     * Exporting.
     */
    choice$1.createChoice = createChoice;
    var choice_1 = choice$1;
    ...
    var createRandom$4 = random_1.createRandom;
    ...
    function createDangerouslyMutatingSample(rng) {
      var customRandom = createRandom$4(rng);
     ...
     */
    createDangerouslyMutatingSample(Math.random);
    ...
    var createRandom$3 = random_1.createRandom;
    ...
    function createFisherYatesSample(rng) {
      var customRandom = createRandom$3(rng);
     ...
     */
    createFisherYatesSample(Math.random);
    ...
    var createRandomIndex$2 = randomIndex_1.createRandomIndex;
    ...
    function createGeometricReservoirSample(rng) {
      var customRandomIndex = createRandomIndex$2(rng);
     ...
     */
    createGeometricReservoirSample(Math.random);
    ...
    var createRandomIndex$1 = randomIndex_1.createRandomIndex;
    ...
    function createNaiveSample(rng) {
      var customRandomIndex = createRandomIndex$1(rng);
    ...
    var createRandom$2 = random_1.createRandom;
    ...
    function createRandomString(rng, alphabet) {
      ...
      var customRandom = createRandom$2(rng),
     ...
     */
    createRandomString(Math.random);
     ...
     * Default reservoir sample using `Math.random`.
     */
    createReservoirSample(Math.random);
    ...
    var createRandom$1 = random_1.createRandom;
    ...
    function createSampleWithReplacements(rng) {
      var customRandom = createRandom$1(rng);
     ...
     */
    createSampleWithReplacements(Math.random);
     ...
     * @return {function}     - The created function.
     */
    function createShuffleInPlace$1(rng) {
     ...
     */
    var shuffleInPlace = createShuffleInPlace$1(Math.random);

    /**
     * Exporting.
     */
    shuffleInPlace.createShuffleInPlace = createShuffleInPlace$1;
    ...
    var createShuffleInPlace = shuffleInPlace_1.createShuffleInPlace;
    ...
    var weightedRandomIndex_1 = weightedRandomIndex;
    ...
    function createWeightedChoice(rngOrOptions) {
      var randomIndex = weightedRandomIndex_1.createWeightedRandomIndex(rngOrOptions);
     ...
     */
    createWeightedChoice(Math.random);
    ...
    var randomWeightedChoice_1 = randomWeightedChoice;
    ...
    function draw(config) {
        ...
        // Creating a new one
        const canvas = createCanvas(canvas_id, document.getElementById(canvas_parent_id), config.canvas.width, config.canvas.height);
        // Setup paperjs
        paperFull.setup(canvas);
        // Creating canvas rectangle
        const canvas_rect = new Rectangle(new Point(0, 0), new Size(config.canvas.width, config.canvas.height));
        // Drawing rectangle
        const canvas_rect_p = new paperFull.Path.Rectangle(canvas_rect);
        canvas_rect_p.strokeColor = "red";
        // Creating grid
        const grid = new UnitGrid(config.grid.rows, config.grid.columns, config.grid.cell_ratio, { column: config.grid.cell_spacing.x, row: config.grid.cell_spacing.y });
        // Fitting grid rectangle
        const grid_rect = canvas_rect.fitRectangleCenter(grid.ratio);
        // Drawing fitted rectangle
        const grid_rect_p = new paperFull.Path.Rectangle(grid_rect);
        grid_rect_p.strokeColor = "teal";
        // Drawing grid
        for (let cell of grid.getCells(grid.getCellHeightFromGridHeight(grid_rect.height), grid_rect.origin)) {
            const cell_rect = new paperFull.Rectangle(cell);
            // --- Tile choice --- //
            ...
            // Selecting tile
            const tile_choice = randomWeightedChoice_1(tile_table);
            // --- Background color --- //
            // Drawing the background!
            const cell_path = new paperFull.Path.Rectangle(cell);
            // Building table of choices
            const bg_color_table = [];
            ...
            //
                ...
                bg_color = randomWeightedChoice_1(bg_color_table);
            }
            cell_path.fillColor = bg_color;
            // --- Drawing tile --- //
            // Drawing accordingly
            let tile;
            if (tile_choice == "line") {
            ...
            //
                ...
                stroke_color = randomWeightedChoice_1(stroke_color_table);
            }
            tile.strokeColor = stroke_color;
        }
        paperFull.view.draw();
    }
    ...
    function create_default_slot_9(ctx) {
    	...
    	function inputinteger_value_binding(value) {
    		/*inputinteger_value_binding*/ ctx[2](value);
    	}

    	let inputinteger_props = { label: "Larghezza" };

    	if (/*config*/ ctx[0].canvas.width !== void 0) {
    		inputinteger_props.value = /*config*/ ctx[0].canvas.width;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*config*/ 1) {
    				updating_value = true;
    				inputinteger_changes.value = /*config*/ ctx[0].canvas.width;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_8(ctx) {
    	...
    	function inputinteger_value_binding_1(value) {
    		/*inputinteger_value_binding_1*/ ctx[3](value);
    	}

    	let inputinteger_props = { label: "Altezza" };

    	if (/*config*/ ctx[0].canvas.height !== void 0) {
    		inputinteger_props.value = /*config*/ ctx[0].canvas.height;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*config*/ 1) {
    				updating_value = true;
    				inputinteger_changes.value = /*config*/ ctx[0].canvas.height;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    // (79:4) <InputGroup label={"Tavola disegno"}>
    function create_default_slot_7(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(79:4) <InputGroup label={\\\"Tavola disegno\\\"}>",
    		ctx
    	});
    ...
    function create_default_slot_6(ctx) {
    	...
    	function inputinteger_value_binding_2(value) {
    		/*inputinteger_value_binding_2*/ ctx[4](value);
    	}

    	let inputinteger_props = { label: "Righe" };

    	if (/*config*/ ctx[0].grid.rows !== void 0) {
    		inputinteger_props.value = /*config*/ ctx[0].grid.rows;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*config*/ 1) {
    				updating_value = true;
    				inputinteger_changes.value = /*config*/ ctx[0].grid.rows;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_5(ctx) {
    	...
    	function inputinteger_value_binding_3(value) {
    		/*inputinteger_value_binding_3*/ ctx[5](value);
    	}

    	let inputinteger_props = { label: "Colonne" };

    	if (/*config*/ ctx[0].grid.columns !== void 0) {
    		inputinteger_props.value = /*config*/ ctx[0].grid.columns;
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*config*/ 1) {
    				updating_value = true;
    				inputinteger_changes.value = /*config*/ ctx[0].grid.columns;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(92:4) <InputGroup label={\\\"Griglia\\\"}>",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	function inputinteger_value_binding_4(value) {
    		/*inputinteger_value_binding_4*/ ctx[6](value, /*t*/ ctx[9]);
    	}

    	let inputinteger_props = { label: tiles_text[/*t*/ ctx[9]] };

    	if (/*config*/ ctx[0].tiles[/*t*/ ctx[9]].density !== void 0) {
    		inputinteger_props.value = /*config*/ ctx[0].tiles[/*t*/ ctx[9]].density;
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*config, Tiles*/ 1) {
    				updating_value = true;
    				inputinteger_changes.value = /*config*/ ctx[0].tiles[/*t*/ ctx[9]].density;
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    // (105:4) <InputGroup label={"Densità forme"}>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*tiles_text, Tiles, config*/ 1) {
    				each_value = Tiles;
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(105:4) <InputGroup label={\\\"Densità forme\\\"}>",
    		ctx
    	});
    ...
    // (117:4) <InputGroup label={"Colore forme"}>
    function create_default_slot_1(ctx) {
    	let inputcolor;
    	let updating_colorConfig;
    	let current;

    	function inputcolor_colorConfig_binding(value) {
    		/*inputcolor_colorConfig_binding*/ ctx[7](value);
    	}

    	let inputcolor_props = {};

    	if (/*config*/ ctx[0].color.tiles !== void 0) {
    		inputcolor_props.colorConfig = /*config*/ ctx[0].color.tiles;
    	}

    	inputcolor = new InputColor({ props: inputcolor_props, $$inline: true });
    	binding_callbacks.push(() => bind(inputcolor, "colorConfig", inputcolor_colorConfig_binding));
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			mount_component(inputcolor, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const inputcolor_changes = {};

    			if (!updating_colorConfig && dirty & /*config*/ 1) {
    				updating_colorConfig = true;
    				inputcolor_changes.colorConfig = /*config*/ ctx[0].color.tiles;
    				add_flush_callback(() => updating_colorConfig = false);
    			}
    		...
    		d: function destroy(detaching) {
    			destroy_component(inputcolor, detaching);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(117:4) <InputGroup label={\\\"Colore forme\\\"}>",
    		ctx
    	});
    ...
    // (122:4) <InputGroup label={"Colore sfondo"}>
    function create_default_slot(ctx) {
    	let inputcolor;
    	let updating_colorConfig;
    	let current;

    	function inputcolor_colorConfig_binding_1(value) {
    		/*inputcolor_colorConfig_binding_1*/ ctx[8](value);
    	}

    	let inputcolor_props = {};

    	if (/*config*/ ctx[0].color.background !== void 0) {
    		inputcolor_props.colorConfig = /*config*/ ctx[0].color.background;
    	}

    	inputcolor = new InputColor({ props: inputcolor_props, $$inline: true });
    	binding_callbacks.push(() => bind(inputcolor, "colorConfig", inputcolor_colorConfig_binding_1));
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_colorConfig && dirty & /*config*/ 1) {
    				updating_colorConfig = true;
    				inputcolor_changes.colorConfig = /*config*/ ctx[0].color.background;
    				add_flush_callback(() => updating_colorConfig = false);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(122:4) <InputGroup label={\\\"Colore sfondo\\\"}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			div1 = element("div");
    			add_location(button, file, 75, 4, 1878);
    			attr_dev(div0, "class", "input svelte-726kjr");
    			add_location(div0, file, 73, 2, 1834);
    			attr_dev(div1, "id", "output");
    			add_location(div1, file, 127, 2, 3223);
    			attr_dev(main, "class", "svelte-726kjr");
    			add_location(main, file, 69, 0, 1795);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, t3);
    			mount_component(inputgroup2, div0, null);
    			append_dev(div0, t4);
    			mount_component(inputgroup3, div0, null);
    			append_dev(div0, t5);
    			mount_component(inputgroup4, div0, null);
    			append_dev(main, t6);
    			append_dev(main, div1);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*handleDraw*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function inputinteger_value_binding(value) {
    		if ($$self.$$.not_equal(config.canvas.width, value)) {
    			config.canvas.width = value;
    			$$invalidate(0, config);
    		}
    	}

    	function inputinteger_value_binding_1(value) {
    		if ($$self.$$.not_equal(config.canvas.height, value)) {
    			config.canvas.height = value;
    			$$invalidate(0, config);
    		}
    	}

    	function inputinteger_value_binding_2(value) {
    		if ($$self.$$.not_equal(config.grid.rows, value)) {
    	...
    	function inputinteger_value_binding_3(value) {
    		if ($$self.$$.not_equal(config.grid.columns, value)) {
    			config.grid.columns = value;
    			$$invalidate(0, config);
    		}
    	}

    	function inputinteger_value_binding_4(value, t) {
    		if ($$self.$$.not_equal(config.tiles[t].density, value)) {
    			config.tiles[t].density = value;
    			$$invalidate(0, config);
    		}
    	}

    	function inputcolor_colorConfig_binding(value) {
    		if ($$self.$$.not_equal(config.color.tiles, value)) {
    			config.color.tiles = value;
    			$$invalidate(0, config);
    		}
    	}

    	function inputcolor_colorConfig_binding_1(value) {
    		if ($$self.$$.not_equal(config.color.background, value)) {
    	...
    	return [
    		...
    		inputcolor_colorConfig_binding,
    		inputcolor_colorConfig_binding_1
    	];
    }
